...
'''
    update.effective_message.reply_photo("https://telegra.ph/file/ddcbae944da24756ed31f.jpg", start_string, parse_mode=ParseMode.MARKDOWN)
...
def repo(update, context):
    ...
    text="https://github.com/", disable_web_page_preview=false)
